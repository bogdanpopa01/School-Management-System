...
public final class Constants {
    ...
    public static final String studentsBinary = "src\\files\\students.dat";
    public static final String professorsBinary = "src\\files\\professors.dat";
    public static final String readStudentsTxt = "src\\files\\readStudents.txt";
    public static final String readProfessorsTxt = "src\\files\\readProfessors.txt";
